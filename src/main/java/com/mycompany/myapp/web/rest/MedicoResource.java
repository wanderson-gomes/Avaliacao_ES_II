            ...
            .map(
                existingMedico -> {
                    if (medico.getIdMedico() != null) {
                        existingMedico.setIdMedico(medico.getIdMedico());
                    }
                    ...
                    if (medico.getCpf() != null) {
                        existingMedico.setCpf(medico.getCpf());
                    }
                    if (medico.getRg() != null) {
                        existingMedico.setRg(medico.getRg());
                    }
                    if (medico.getEspecialidade() != null) {
                        existingMedico.setEspecialidade(medico.getEspecialidade());
                    }
                    if (medico.getContato() != null) {
                        existingMedico.setContato(medico.getContato());
                    }
